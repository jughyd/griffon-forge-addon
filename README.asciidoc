...
image:https://badges.gitter.im/Join%20Chat.svg[link="https://gitter.im/jughyd/griffon-forge-addon?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"]
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The griffon-forge-addon addon enables blah blah...)
...
----
<dependency>
   <groupId>org.codehaus.griffon.forge</groupId>
   <artifactId>griffon-forge-addon</artifactId>
